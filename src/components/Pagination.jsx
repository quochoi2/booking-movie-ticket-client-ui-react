    ...
    <div className="flex justify-center items-center gap-2 mb-10 mt-5">
      ...
      <button
        className={`w-[45px] h-[45px] flex items-center justify-center rounded-full border ${
          currentPage > 1 ? 'border-white text-white hover:bg-gray-700 cursor-pointer' : 'border-gray-500 text-gray-500 cursor-not-allowed'
        }`}
        ...
        <>
          <button
            className={`w-[45px] h-[45px] flex items-center justify-center rounded-full border cursor-pointer ${
              1 === currentPage ? 'border-white text-white bg-gray-700 cursor-pointer' : 'border-gray-400 text-gray-400 hover:bg-gray-700'
            }`}
            onClick={() => handlePageChange(1)}
          >
            1
          </button>
          {getVisiblePages()[0] > 2 && <span className="text-gray-400 px-2">...</span>}
        </>
      )}
      ...
      {getVisiblePages().map((page) => (
        <button
          key={page}
          className={`w-[45px] h-[45px] flex items-center justify-center rounded-full border cursor-pointer ${
            page === currentPage ? 'border-white text-white bg-gray-700 cursor-pointer' : 'border-gray-400 text-gray-400 hover:bg-gray-700'
          }`}
      ...
      {getVisiblePages()[getVisiblePages().length - 1] < totalPages && (
        <>
          ...
          <button
            className={`w-[45px] h-[45px] flex items-center justify-center rounded-full border ${
              totalPages === currentPage ? 'border-white text-white bg-gray-700 cursor-pointer' : 'border-gray-400 text-gray-400 hover:bg-gray-700'
            }`}
      ...
      <button
        className={`w-[45px] h-[45px] flex items-center justify-center rounded-full border ${
          currentPage < totalPages ? 'border-white text-white hover:bg-gray-700 cursor-pointer' : 'border-gray-500 text-gray-500 cursor-not-allowed'
        }`}
        onClick={() => handlePageChange(currentPage + 1)}
