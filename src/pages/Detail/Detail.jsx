...
const Detail = () => {
  ...
  if (!movie)
    return <div className="text-center py-8">Không có thông tin phim</div>
            ...
            <div className="anime__details__content">
              <div className="grid grid-cols-12 gap-4">
                <div className="col-span-12 md:col-span-3">
                  {/* movie.image */}
                  <div
                    className="anime__details__pic bg-cover bg-center"
                    style={{
                      backgroundImage:
                        `url(${movie.image})` ||
                        `url(/img/anime/details-pic.jpg)`
                    }}
                  >
                ...
                <div className="col-span-12 md:col-span-9">
                  <div className="anime__details__text">
                    <div className="anime__details__title">
                      {/* movie.title */}
                      <h3>
                        {movie.title || 'Fate Stay Night: Unlimited Blade'}
                      </h3>
                      {/* movie.titleAnother */}
                      <span>
                        {movie.titleAnother ||
                    ...
                    <div className="anime__details__widget">
                      <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-4">
                        <ul>
                          {/* movie.type */}
                          <li>
                            <span>Thể loại:</span> {movie.type || 'TV Series'}
                          </li>
                          {/* movie.studio */}
                          <li>
                            <span>Studio:</span> {movie.studio || 'Lerche'}
                          </li>
                          {/* moive.dateAired */}
                          <li>
                            <span>Khởi chiếu:</span>{' '}
                            {formatDate(movie.dateAired) || '20/10/2025'}
                          </li>
                          ...
                          <li>
                            <span>Thể loại:</span> Hành động, Phiêu lưu, Fantasy
                          </li>
                        </ul>
                        <ul>
                          {/* movie.score */}
                          <li>
                            <span>Điểm số:</span> {movie.score || 8} / 10
                          </li>
                          {/* movie.Previews.count đếm cho tôi xem có bao nhiêu bình luận */}
                          <li>
                            <span>Đánh giá:</span>{' '}
                            {movie.Previews?.length || 12}
                          </li>
                          {/* movie.duration */}
                          <li>
                            <span>Thời lượng:</span> {movie.duration || 120}{' '}
                            phút
                          </li>
                          {/* movie.quality */}
                          <li>
                            <span>Chất lượng:</span> {movie.quality || 'HD'}
                          </li>
                          {/* de mac dinh */}
                          <li>
                            <span>Lượt theo dõi:</span> 131,541
                          </li>
                        </ul>
                      </div>
                    </div>
                    <div className="anime__details__btn flex space-x-4 mt-4">
                      ...
                      <button className="follow-btn bg-blue-500 text-white py-2 px-4 rounded cursor-pointer">
