...
const CheckoutModal = ({ onClose, onConfirmPayment }) => {
  ...
  const paymentMethods = [
    ...
    {
      id: 4,
      name: 'Tiền mặt tại rạp',
      icon: 'https://cdn-icons-png.flaticon.com/512/2703/2703544.png'
    }
  ]
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <div className="mb-6">
                <h3
                  className="text-xl text- font-semibold border-b border-gray-600 pb-2 mb-4"
                ...
                <div className="space-y-3">
                  ...
                  <p>
                    <span className="font-medium">Rạp:</span> {orderData.cinema}
                  </p>
                  <p>
                    <span className="font-medium">Ngày:</span> {orderData.date}
                  </p>
                  <p>
              ...
              <div className="mb-6">
                <h3
                  className="text-xl font-semibold border-b border-gray-600 pb-2 mb-4"
                  style={{ fontSize: '20px' }}
                >
                  Ghế đã chọn
                </h3>
              ...
              {orderData.services.length > 0 && (
                <div className="mb-6">
                  ...
                  <div className="space-y-2 py-2">
                    ...
                    <div className="font-medium pt-2 border-t border-gray-600">
                      Tổng dịch vụ:{' '}
                      {orderData.totalServicePrice.toLocaleString()}đ
                    </div>
                  </div>
                </div>
              )}
