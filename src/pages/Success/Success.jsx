        ...
        <div className="container mx-auto text-center px-10 py-14">
          <div className="bg-gray-800 p-8 rounded-md max-w-lg mx-auto">
            ...
            <p className="text-gray-300 mb-6">
              Tài khoản của bạn đã được kích hoạt và bạn có thể bắt đầu sử dụng
              tài khoản này. Giao diện sẽ chuyển về trang đang nhập tron vòng 5
              giây nữa, bạn có thể quay lại trang đăng nhập bằng cách bấm vào
              nút phía bên dưới.
            </p>
            <p className="text-gray-300 mb-6">
