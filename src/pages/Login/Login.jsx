          ...
          <div className="flex flex-wrap">
            <div className="w-full lg:w-1/2 p-8 border-r-1px border-white">
              <div className="bg-gray-800 p-8 rounded-md">
                <h3 className="text-2xl font-bold" style={{ marginBottom: '15px' }}>Đăng nhập</h3>
                {error && <p>{error}</p>}
                ...
                <a style={{ marginTop: '15px' }} className="text-sm text-gray-400 hover:text-white mt-4 block text-center">
                  Quên mật khẩu?
                </a>
              </div>
            </div>
            <div className="w-full lg:w-1/2 flex flex-col items-center justify-center">
              <h3 className="text-2xl font-bold mb-4" style={{ marginBottom: '15px' }}>Không có tài khoản?</h3>
              <a
                href="/register"
          ...
          <div className="mt-12">
            ...
            <div className="flex justify-center flex-col gap-4 mt-4">
              <div className='flex justify-center mx-auto'>
                <a href="#" className="bg-blue-600 py-3 px-6 rounded-md font-bold hover:bg-blue-700 transition flex justify-center w-[400px]">
              ...
              <div className='flex justify-center mx-auto'>
                <a href="#" className="bg-blue-400 py-3 px-6 rounded-md font-bold hover:bg-blue-500 transition flex justify-center w-[400px]">
