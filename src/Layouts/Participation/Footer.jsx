        ...
        <div className="grid grid-cols-1 md:grid-cols-8 gap-6 text-center md:text-left items-center">
          ...
          <div className='col-span-2'>
            <p className="text-gray-400" style={{ margin: 0 }}>
              Hoàn thành vào &copy; {new Date().getFullYear()} | Lấy cảm hứng giao diện từ
              <i className="fas fa-heart text-red-500 mx-1"></i> by
              <a href="https://colorlib.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline ml-1">Colorlib</a>
            </p>
          </div>
        </div>
      </div>
